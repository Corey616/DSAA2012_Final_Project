...
PROJECT_BASE_DIR = Path(__file__).absolute().parent.parent.parent  # Project root
...
def configure_all_cache_dirs():
    """Configure cache directories for all ML libraries — FORCE override."""
    cache_path = str(MODELS_CACHE_DIR)

    # Force-set (NOT setdefault) — inherited env vars may point elsewhere
...
def verify_model_integrity(
    ...
    # Verify snapshot contains actual model files (not just empty dirs)
